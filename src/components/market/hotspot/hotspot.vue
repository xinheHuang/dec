      ...
      <div class="charts">
        <div>
          ...
          <div style="width: 100%;text-align: center;vertical-align: middle">
            <div v-if="!barChartData || barChartData.length===0">暂无数据</div>
        ...
        <div>
          <div style="width: 100%;text-align: center;vertical-align: middle">
            <div v-if="!areaChartData || areaChartData.length===0">暂无数据</div>
    ...
    methods: {
      async changeChartType(type) {
        ...
        if (type.name==='全部'){
          ...
          const subCategories=(await this.$http.get(`/api/market/categories/${type.CID}`)).data.map((c)=>c.name);
          data=this.readNumberData.filter((d)=>subCategories.includes(d['relation.industry']))
        }
        console.log(data);
        ...
        this.areaChartData=[
          ...
          return {
            ...
            ...Object.keys(d).filter((key)=>key!=='date').reduce((prev,key)=>{
              return {
                ...prev,
                [key]:d[key]/100
              }
        ...
        this.areaChartKeys=Object.keys(this.areaChartData[0]).filter((key)=>key!=='date');
